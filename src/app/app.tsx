...
const App = () => {
  ...
  const handleColors = (color: string) => {
    if (color === "mint") {
      document.documentElement.style.setProperty('--main-light-max', 'rgb(232, 244, 244)')
      document.documentElement.style.setProperty('--main-light', 'rgb(170, 219, 219)')
      document.documentElement.style.setProperty('--main-medium', 'rgb(65, 164, 177)')
      document.documentElement.style.setProperty('--secondary', 'rgb(23, 116, 139)')
      document.documentElement.style.setProperty('--main', 'rgb(41, 80, 98))')
    }
    if (color === "blue") {
      document.documentElement.style.setProperty('--main-light-max', 'rgb(236 249 255)')
      document.documentElement.style.setProperty('--main-light', 'rgb(176 222 239)')
      document.documentElement.style.setProperty('--main-medium', 'rgb(94, 166, 194)')
      document.documentElement.style.setProperty('--secondary', 'rgb(49, 120, 183)')
