    ...
    return ( 
        <div className={classNames("newsletter", size)}>
            ...
            >
                ...
                />
                 {sent && !valid && <Message  type="error" size="small" wrapped className={"error_message--float"}>Podano niepoprawny email</Message>}
                <Button 
                    role="important"
                    type="submit"
            ...
            {sent && valid && <Message type="info">
                Dołączyłeś do naszej skrzynki newslettera! Od teraz jako pierwszy będziesz otrzymywał bieżące promocje i okazje.
            </Message>}
        </div>
    )
}
