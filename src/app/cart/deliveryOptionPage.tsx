  ...
  return (
    <div className="buy">
      <form className="delivery_options__form card">
        <div
          className={classNames("delivery_option", {
            "delivery_option--active": option === "personal",
          })}
        ...
        <div
          className={classNames("delivery_option", {
            "delivery_option--active": option === "courierDPD",
          })}
          onClick={() => setOption("courierDPD")}
        >
          <Radio
            className="delivery_option_radio"
            id="courierDPD"
            label="Kurier DPD"
            groupName="delivery"
            checked={"courierDPD" === option}
          />
        ...
        <div
          className={classNames("delivery_option", {
            "delivery_option--active": option === "courierGLS",
          })}
          onClick={() => setOption("courierGLS")}
        >
          <Radio
            id="courierGLS"
            label="Kurier GLS"
            groupName="delivery"
            checked={"courierGLS" === option}
          />
          <span className="delivery_option_info">2-7 dni roboczych</span>
          <span className="delivery_option_price">Za darmo</span>
        </div>
        ...
        >
          ...
          {displayed && (
            <div className="message--float">
              Obecnie opcja ta jest chwilowo niedostępna
            </div>
          )}
        </div>
      </form>
